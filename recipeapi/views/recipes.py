...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Recipe
        fields = ['id', 'name', 'image', 'cooking_instructions', 'is_owner', 'ingredients']
    ...
    def update(self, request, pk=None):
        try:
            ...
            if serializer.is_valid():
                ...
                recipe.cooking_instructions = serializer.validated_data.get('cooking_instructions', recipe.cooking_instructions)
                recipe.save()
